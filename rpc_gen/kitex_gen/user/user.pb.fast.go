...
func (x *RegisterReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.PasswordComfirm, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *RegisterReq) fastWriteField3(buf []byte) (offset int) {
	if x.PasswordComfirm == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 3, x.GetPasswordComfirm())
	return offset
}
...
func (x *RegisterReq) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetPasswordComfirm())
	return n
}
