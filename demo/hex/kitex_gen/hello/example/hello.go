...
type HelloReq struct {
	// 对应HTTP query参数
	Name string `thrift:"Name,1" frugal:"1,default,string" json:"Name" query:"name"`
}
...
type HelloResp struct {
	RespBody string `thrift:"RespBody,1" frugal:"1,default,string" form:"RespBody" json:"RespBody" query:"RespBody"`
}
...
type HelloServiceHelloMethodArgs struct {
	Request *HelloReq `thrift:"request,1" frugal:"1,default,HelloReq"`
}
...
type HelloServiceHelloMethodResult struct {
	Success *HelloResp `thrift:"success,0,optional" frugal:"0,optional,HelloResp"`
}
